...
{
    public static class RapidCMSMiddlewareAzureFunctions
    {
        ...
        /// <summary>
        /// Use this method to setup the Repository APIs to support RapidCMS WebAssenbly on separate Azure Functions.
        /// </summary>
        /// <param name="services"></param>
        /// <param name="config"></param>
        /// <returns></returns>
        public static IFunctionsHostBuilder AddRapidCMSApi(this IFunctionsHostBuilder builder, Action<IApiConfig>? config = null)
        {
